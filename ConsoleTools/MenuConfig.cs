...
namespace ConsoleTools
{
    public class MenuConfig
    {
        ...
        public Action WriteHeaderAction = () => Console.WriteLine("Выберите операцию:");
        ...
        public Action<IReadOnlyList<string>> WriteBreadcrumbAction =
            titles => Console.WriteLine(string.Join(" > ", titles));
