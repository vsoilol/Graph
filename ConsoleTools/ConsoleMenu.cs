...
namespace ConsoleTools
{
    public class ConsoleMenu
    {
        ...
        /// <summary>
        /// Creates ConsoleTools instance with possibility to pre-select items via console parameter
        /// </summary>
        ...
        public void Show()
        {
            ...
            while (true)
            {
                do
                {
                    ...
                    if (_config.IsSeparator)
                    {
                        var width = this.console.WindowWidth;
                        var separatorString = "";
                        for (; width > 0; width--)
                        {
                            separatorString += "-";
                        ...
                        this.console.Write(separatorString);
                    }
